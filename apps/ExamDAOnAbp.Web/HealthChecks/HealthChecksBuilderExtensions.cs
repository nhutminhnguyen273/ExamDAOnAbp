...
{
    public static void AddExamDAOnAbpHealthChecks(this IServiceCollection services)
    {
        // Add your health checks here
        var healthChecksBuilder = services.AddHealthChecks();
        healthChecksBuilder.AddCheck<ExamDAOnAbpHealthCheck>("ExamDAOnAbp Health Check");
        ...
        {
            settings.AddHealthCheckEndpoint("ExamDAOnAbp Health Status", healthCheckUrl);
        });

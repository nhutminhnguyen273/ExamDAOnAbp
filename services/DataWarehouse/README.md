...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 5295363f-c0dc-44e5-bbad-8ec475999bbd
```

> `5295363f-c0dc-44e5-bbad-8ec475999bbd` is the password of the certificate, you can change it to any password you want.

...
[DependsOn(
    typeof(DataWarehouseApplicationTestModule),
    typeof(DataWarehouseEntityFrameworkCoreModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
    )]
public class DataWarehouseEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        using (var context = new DataWarehouseDbContext(options))
        {

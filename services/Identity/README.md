...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p e0075909-12ea-4436-be15-e3dcd87e9e6a
```

> `e0075909-12ea-4436-be15-e3dcd87e9e6a` is the password of the certificate, you can change it to any password you want.
